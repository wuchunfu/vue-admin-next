      ...
      <el-scrollbar class="layout-breadcrumb-seting-bar">
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker v-model="getThemeConfig.primary" size="small"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker v-model="getThemeConfig.success" size="small"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker v-model="getThemeConfig.info" size="small"
                             @change="onColorPickerChange('info')"></el-color-picker>
          </div>
        </div>
        <div class="layout-breadcrumb-seting-bar-flex">
          <div class="layout-breadcrumb-seting-bar-flex-label">warning</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker v-model="getThemeConfig.warning" size="small"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker v-model="getThemeConfig.danger" size="small"
                             @change="onColorPickerChange('danger')"></el-color-picker>
          </div>
        </div>
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker v-model="getThemeConfig.topBar" size="small"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker v-model="getThemeConfig.menuBar" size="small"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt14">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch v-model="getThemeConfig.isColumnsMenuBarColorGradual"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15 mb27">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select v-model="getThemeConfig.columnsAsideLayout" placeholder="请选择" size="mini" style="width: 90px"
                       @change="setLocalThemeConfig">
        ...
        <div class="copy-config">
          ...
          <el-button size="small" class="copy-config-btn" type="primary" ref="copyConfigBtnRef"
